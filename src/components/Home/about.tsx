...
export default function About() {
  return (
    <main className="flex relative mx-auto h-screen">
      <div className="grid lg:grid-cols-2 gap-4 items-center">
        ...
        <div className="max-auto">
          <div className="text-center text-gray-100 hover:text-gray-300 text-3xl">
            <div className="mx:10px flex-center text-center text-gray-100 hover:text-gray-300 text-3xl">
              <h2>
                <span className="font-bold text-4xl">Welcome to my page!</span>
              </h2>
            </div>
          </div>
          <div className="text-gray-100 text-xl my-10 mx-10">
            ...
            <br />
            <p>
              More information is coming! In the meantime you can take a look on
              my tech-stack below or check up by github.{' '}
              <a href="https://github.com/kevinkrs7">
                <svg
                  fill="currentColor"
                  viewBox="0 0 32.58 31.77"
                  className="w-10 m-3 mx-auto"
                >
                  <path
                    fillRule="evenodd"
